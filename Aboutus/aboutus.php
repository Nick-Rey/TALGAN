...
<html lang="en">
 <head>
    ...
    <title>Главная</title>
    <link rel="stylesheet" href="CSS/mainstyleaboutus.css">
   ...
   <header>
    ...
    <div class="production_block">
         ...
         <div class="production_block_rightblock">
             <img class="production_block_picture1" src="CSS/image/picture/millstones.jpg">
         </div>
    </div>
    ...
    <div class="production_block">
         ...
         <div class="production_block_rightblock">
             <img class="production_block_picture3" src="CSS/image/picture/product.jpg">
         </div>
    </div>
